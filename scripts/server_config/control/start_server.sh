...
sudo docker run --privileged --restart unless-stopped --name quicker_server --network quicker -p 4433:4433/udp -p 4434:4434/udp -p 4435:4435/udp --volume=/Users/yudai/switching-prioritization-logs:/logs -d quicker/quicker:latest "$@"
