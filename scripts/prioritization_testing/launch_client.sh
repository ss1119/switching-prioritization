...
LOG_LEVEL=debug DISABLE_STDOUT=false ../node/out/Release/node --max-old-space-size=8192 ./out/mainclient.js $2_$1_client_1 $2_$1_client_1.log public/prioritization_testcases/$2/prioritization_resource_lists/resource_list.json